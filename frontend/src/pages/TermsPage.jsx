        ...
        <div className="member_terms_wrap center">
          <div className="terms">
            <div className="terms_textarea">
              <p>제1조(목적)</p>
              <p>
                이 약관은 다올커피(전자상거래 사업자)가 운영하는
                다올커피(이하 “몰”이라 한다)에서 제공하는 인터넷 관련
              ...
              <p>
                ...
                통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알
                수 있도록 다올커피 사이버몰의 초기 서비스화면(전면)에
                게시합니다. 다만, 약관의 내용은 이용자가 연결화면을
              ...
              <p>
                ...
                관하여는 전자상거래등에서의소비자보호에관한법률,
                약관의규제등에관한법률, 공정거래위원회가 정하는
                전자상거래등에서의소비자보호지침 및 관계법령 또는
                상관례에 따릅니다.
              </p>
              <br />
              ...
              <p>
                ...
                이용자 중 다음 각호에 해당하지 않는 한 회원으로
                등록합니다.
              </p>
              <p>
                1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에
                회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에
                의한 회원자격 상실후 3년이 경과한 자로서 “몰”의
              ...
              <p>
                ④ 회원은 제15조제1항에 의한 등록사항에 변경이 있는
                경우, 즉시 전자우편 기타 방법으로 “몰”에 대하여 그
                변경사항을 알려야 합니다.
              </p>
              <p>
                ⑤ 회원은 "몰"이 정한 회원가입 및 서비스 기준 충족시
                쿠폰(할인, 마일리지, 적립금, 포인트, 이벤트, 사은품 등)
                혜택이 지급 적용되오며, 알림톡(문자), 공지사항 등으로
                안내됩니다.
              </p>
              <br />
              ...
              <p>
                ...
                변경 및 취소를 요청할 수 있고 “몰”은 배송전에 이용자의
                요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야
              ...
              <p>
                ...
                일부를 받은 날부터 2영업일 이내에 조치를 취합니다.
                이때 “몰”은 이용자가 재화등의 공급 절차 및 진행 사항을
                확인할 수 있도록 적절한 조치를 합니다.
              </p>
              <p>
                ②“몰”은 이용자가 구매한 재화에 대해 배송수단,
                수단별 배송비용 부담자, 수단별 배송기간 등을
                명시합니다. 만약 “몰”이 약정 배송기간을 초과한
                경우에는 그로 인한 이용자의 손해를 배상하여야 합니다.
                다만 “몰”이 고의?과실이 없음을 입증한 경우에는
                그러하지 아니합니다.
              </p>
              <br />
              <p>제14조(환급)</p>
              ...
              <p>
                ...
                3영업일 이내에 이미 지급받은 재화등의 대금을
                환급합니다. 이 경우 “몰”이 이용자에게 재화등의
                환급을 지연한 때에는 그 지연기간에 대하여
                공정거래위원회가 정하여 고시하는 지연이자율을 곱하여
                산정한 지연이자를 지급합니다.
              </p>
              <p>
                ② “몰”은 위 대금을 환급함에 있어서 이용자가
                신용카드 또는 전자화폐 등의 결제수단으로 재화등의
                대금을 지급한 때에는 지체없이 당해 결제수단을 제공한
                사업자로 하여금 재화등의 대금의 청구를 정지 또는
                취소하도록 요청합니다.
              </p>
              <p>
                ...
                않습니다. 다만 재화등의 내용이 표시·광고 내용과
                다르거나 계약내용과 다르게 이행되어 청약철회등을
                하는 경우 재화등의 반환에 필요한 비용은 “몰”이
                부담합니다.
              </p>
              <p>
                ④ 이용자가 재화등을 제공받을때 발송비를 부담한
                경우에 “몰”은 청약철회시 그 비용을 누가 부담하는지를
              ...
              <p>제23조(분쟁해결)</p>
              <p>
                ① “몰”은 이용자가 제기하는 정당한 의견이나
                불만을 반영하고 그 피해를 보상처리하기 위하여
                피해보상처리기구를 설치?운영합니다.
              </p>
              <p>
                ② “몰”은 이용자로부터 제출되는 불만사항 및
                의견은 우선적으로 그 사항을 처리합니다. 다만, 신속한
                처리가 곤란한 경우에는 이용자에게 그 사유와
                처리일정을 즉시 통보해 드립니다.
              </p>
              <p>
                ③“몰”과 이용자간에 발생한 전자상거래 분쟁과
              ...
              <p>제25조(적립금 및 쿠폰)</p>
              <p>
                ①“몰”은 회원이 쇼핑몰 내에서 상품을 구매하거나,
                상품평의 작성, 상품 배송확인 등을 하는 경우 회원에게
                일정한 적립금 및 쿠폰을 부여할 수 있습니다. 다만,
                상품구매 후 취소 또는 반품을 할 경우에는 상품 구매
                시 회사가 부여한 적립금 및 쿠폰을 회수합니다.
              </p>
              <p>②적립금 및 쿠폰의 유효기간 및 사용방법은 “몰”의 정책에 따릅니다.</p>
              <p>
                ③“몰”은 회원에게 일정 금액 또는 일정비율을 할인
                받을 수 있는 쿠폰을 발급할 수 있습니다. 쿠폰의 종류
                및 내용과 발급여부 및 사용방법은 “몰”의 정책에 따라
                변경될 수 있습니다.
              </p>
              <p>④쿠폰은 사전에 명시된 유효기간 내에 사용될 수 있으며, 유효기간이 경과하거나 회원 자격이 상실되면 소멸합니다.</p>
              <p>⑤“몰”은 적립금 및 쿠폰과 관련하여 다음의 사항을 회원에게 통지합니다.</p>
              <p>①회원 가입 혜택의 부여</p>
              <p>②첫 구매 고객에게 감사 쿠폰의 부여</p>
              <p>③적립금 및 쿠폰의 유효기간 만료 및 소멸</p>
              <p>④등급별 지급되는 월별 쿠폰</p>
              <p>⑤그 외 적립금 및 쿠폰의 부여, 사용, 만료, 소멸 등에 관한 사항</p>
              <br />
              <p>부 칙(시행일) 이 약관은 2023년 12월 30일부터 시행합니다.</p>
            </div>
          </div>
        </div>
      </div>
