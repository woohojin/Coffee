...
const TERMS_TEXT = ` 제1조(목적)
              이 약관은 다올커피(전자상거래 사업자)가 운영하는 다올커피(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.

              ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

              제2조(정의)
              ①“몰” 이란 다올커피가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
              ...
              ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?모사전송번호?전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 다올커피 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
              ...
              ⑤ 회원은 "몰"이 정한 회원가입 및 서비스 기준 충족시 쿠폰(할인, 마일리지, 적립금, 포인트, 이벤트, 사은품 등) 혜택이 지급 적용되오며, 알림톡(문자), 공지사항 등으로 안내됩니다.
              제7조(회원 탈퇴 및 자격 상실 등)
              ...
              제25조(적립금 및 쿠폰)
              ①“몰”은 회원이 쇼핑몰 내에서 상품을 구매하거나, 상품평의 작성, 상품 배송확인 등을 하는 경우 회원에게 일정한 적립금 및 쿠폰을 부여할 수 있습니다. 다만, 상품구매 후 취소 또는 반품을 할 경우에는 상품 구매 시 회사가 부여한 적립금 및 쿠폰을 회수합니다.
              ②적립금 및 쿠폰의 유효기간 및 사용방법은 “몰”의 정책에 따릅니다.
              ③“몰”은 회원에게 일정 금액 또는 일정비율을 할인 받을 수 있는 쿠폰을 발급할 수 있습니다. 쿠폰의 종류 및 내용과 발급여부 및 사용방법은 “몰”의 정책에 따라 변경될 수 있습니다.
              ④쿠폰은 사전에 명시된 유효기간 내에 사용될 수 있으며, 유효기간이 경과하거나 회원 자격이 상실되면 소멸합니다.
              ⑤“몰”은 적립금 및 쿠폰과 관련하여 다음의 사항을 회원에게 통지합니다.
              ①회원 가입 혜택의 부여
              ②첫 구매 고객에게 감사 쿠폰의 부여
              ③적립금 및 쿠폰의 유효기간 만료 및 소멸
              ④등급별 지급되는 월별 쿠폰
              ⑤그 외 적립금 및 쿠폰의 부여, 사용, 만료, 소멸 등에 관한 사항

              부 칙(시행일) 이 약관은 2023년 12월 30일부터 시행합니다.`;

const PRIVACY_TEXT = `■ 개인정보의 수집 및 이용목적
              ...
              ■ 개인정보의 보유 및 이용기간
              (1) 이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용 목적이 달성되면 지체 없이 파기합니다. 단, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 다음과 같이 거래 관련 권리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을 경우에는 그 기간동안 보유합니다.
...
function MemberTermsPage() {
  ...
  const handleFirstCheck = (e) => {
    const checked = e.target.checked;
    setFirstCheck(checked);
    setCheckAll(checked && secondCheck);
  };

  const handleSecondCheck = (e) => {
    const checked = e.target.checked;
    setSecondCheck(checked);
    setCheckAll(firstCheck && checked);
  };
        ...
        <div className="member_terms_wrap center">
          <div className="member_terms">
            <p>
              <input
                type="checkbox"
                id="terms-checkbox-all"
                checked={checkAll}
                onChange={handleCheckAll}
              />
              <label htmlFor="terms-checkbox-all">
                (필수) 이용약관 및 개인정보수집 및 이용에 모두 동의합니다.
              </label>
            </p>
            <div className="member_terms_textarea">
              <p>[필수] 이용약관 동의</p>
              <textarea readOnly value={TERMS_TEXT} />
              <p>
                <input
                  type="checkbox"
                  id="terms-checkbox-first"
                  checked={firstCheck}
                  onChange={handleFirstCheck}
                />
                <label htmlFor="terms-checkbox-first">
                  이용약관에 동의하십니까?
                </label>
              </p>
            </div>
            <div className="member_terms_textarea">
              ...
              <textarea readOnly value={PRIVACY_TEXT} />
              <p>
                <input
                  type="checkbox"
                  id="terms-checkbox-second"
                  checked={secondCheck}
                  onChange={handleSecondCheck}
                />
                <label htmlFor="terms-checkbox-second">
                  개인정보 수집 및 이용에 동의하십니까?
                </label>
              </p>
            </div>
            <div className="member_terms_button">
              <input
                type="button"
                value="회원가입 진행"
