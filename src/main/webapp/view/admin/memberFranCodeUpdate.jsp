...
<main id="admin_page">
  <div class="admin_page_wrap">
    <div class="page_head">
      <a href="${ pageContext.request.contextPath }/admin/memberFranCodeUpdate">
        <h1>멤버 가맹점코드 수정</h1>
      </a>
    </div>
    <div class="search_form_wrap center">
      <div class="inline_wrap">
        <form class="search_form"
              action="${ pageContext.request.contextPath }/admin/memberFranCodeUpdatePro"
              method="post"
        ...
        >
          <div style="justify-content: center;">
            ...
            <label for="memberFranCode" style="flex: none;">가맹점코드</label>
            <input type="text" id="memberFranCode" name="memberFranCode" value="">
          </div>
        </form>
      </div>
    </div>
...
<script>
    function submit() {
        ...
        if(confirm("멤버 가맹점코드가 변경됩니다. 진행하시겠습니까?") === true) {
            form.submit();
            return true;
        } else {
            return false;
