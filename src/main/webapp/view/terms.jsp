    ...
    <div class="member_terms_wrap center">
      <div class="terms">
        <div class="terms_textarea">
          <p>제1조(목적)</p>
          <p>이 약관은 주식회사 다올커피(전자상거래 사업자)가 운영하는 다올커피(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.</p>
          <br/>
          <p>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</p>
          <br/>
          <p>제2조(정의)</p>
          <p>①“몰” 이란 주식회사 다올커피가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</p>
          ...
          <p>① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?모사전송번호?전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 다올커피 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</p>
          ...
          <p> ④ “몰”이 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의 초기화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다.
          ...
          <p>⑤ 회원은 "몰"이 정한 회원가입 및 서비스 기준 충족시 쿠폰(할인, 마일리지, 적립금, 포인트, 이벤트, 사은품 등) 혜택이 지급 적용되오며, 알림톡(문자), 공지사항 등으로 안내됩니다.</p>
          <br/>
          ...
          <p>제25조(적립금 및 쿠폰)</p>
          <p>①“몰”은 회원이 쇼핑몰 내에서 상품을 구매하거나, 상품평의 작성, 상품 배송확인 등을 하는 경우 회원에게 일정한 적립금 및 쿠폰을 부여할 수 있습니다. 다만, 상품구매 후 취소 또는 반품을 할 경우에는 상품 구매 시 회사가 부여한 적립금 및 쿠폰을 회수합니다.</p>
          <p>②적립금 및 쿠폰의 유효기간 및 사용방법은 “몰”의 정책에 따릅니다.</p>
          <p>③“몰”은 회원에게 일정 금액 또는 일정비율을 할인 받을 수 있는 쿠폰을 발급할 수 있습니다. 쿠폰의 종류 및 내용과 발급여부 및 사용방법은 “몰”의 정책에 따라 변경될 수 있습니다.</p>
