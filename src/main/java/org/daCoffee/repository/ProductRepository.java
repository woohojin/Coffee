...
public interface ProductRepository extends JpaRepository<Product, String>, JpaSpecificationExecutor<Product> {
  ...
  Page<Product> findByProductTierAndProductType(Integer productTier, ProductType productType, Pageable pageable);

  // 제품등급 + 타입으로 제품 수 조회
  int countByProductTierAndProductType(Integer productTier, ProductType productType);
