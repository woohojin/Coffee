...
<body>
          ...
          <div class="product_detail_wrap">
            <div class="product_detail">
              <div class="product_detail_img">
                <img src="${ pageContext.request.contextPath }/files/bean/${ requestScope.product.productCode }/${ requestScope.product.productFile }" alt="" />
              </div>
                    ...
                    <div class="product_quantity">
                      ...
                      <div class="product_quantity_btn">
                        <button type="button" class="left_btn center" onclick="decreaseProductQuantity()">
                          <img src="${ pageContext.request.contextPath }/image/minus.png" alt="" />
                        </button>
                        <button type="button" class="right_btn center" onclick="increaseProductQuantity()">
                          <img src="${ pageContext.request.contextPath }/image/plus.png" alt="" />
                        </button>
                      </div>
          ...
          <ul class="product_detail_main">
            <li>
              ...
              <div class="product_detail_content_wrap">
                <img src="${ pageContext.request.contextPath }/files/bean/${ requestScope.product.productCode }/${ requestScope.detailmageName }" alt="" />
              </div>
            </li>
            <li>
  ...
  <script src="${ pageContext.request.contextPath }/js/scrollMove.js"></script>
</body>
