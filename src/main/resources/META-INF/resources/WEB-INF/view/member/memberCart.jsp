            ...
            <c:choose>
              <c:when test="${ c.productType == 0 }">
                <td class="member_cart_image">
                  <img src="${ pageContext.request.contextPath }/files/bean/${ c.productCode }/${ c.productFile }" alt=""/>
                </td>
              </c:when>

              <c:when test="${ c.productType == 1 }">
                <td class="member_cart_image">
                  <img src="${ pageContext.request.contextPath }/files/mix/${ c.productCode }/${ c.productFile }" alt=""/>
                </td>
              </c:when>

              <c:when test="${ c.productType == 2 }">
                <td class="member_cart_image">
                  <img src="${ pageContext.request.contextPath }/files/cafe/${ c.productCode }/${ c.productFile }" alt=""/>
                </td>
              </c:when>
            </c:choose>
              ...
              >
                ...
                <div class="member_cart_quantity_btn">
                  <button type="button" class="up_btn" onclick="increaseCartQuantity(${ status.index })">
                    <img src="${ pageContext.request.contextPath }/image/triangle-up.png" alt="" />
                  </button>
                  <button type="button" class="down_btn" onclick="decreaseCartQuantity(${ status.index })">
                    <img src="${ pageContext.request.contextPath }/image/triangle-down.png" alt="" />
                  </button>
                </div>
              </form>
            </td>
